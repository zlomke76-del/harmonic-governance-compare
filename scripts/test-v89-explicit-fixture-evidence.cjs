...
assert(adapter.includes('source_class: "synthetic_test_fixture"'), "fixture evidence not explicitly labeled");
...
assert(page.includes("!selectedScenarioOption?.realityWitness"), "structured fixture does not disable harness inference");
