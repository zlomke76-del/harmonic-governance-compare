...
assert(page.includes('{ id: "v4_1", label: "Harmonic v4.2.0 · Frozen Primary"'),"v4.2.0 is not primary option");
assert(page.includes('useState<RuntimeTarget>("v4_1")'),"frozen primary is not default runtime");
assert(compare.includes('z.enum(["v4_1", "v4", "v2"]).default("v4_1")'),"API default is not frozen primary route");
